...
import static com.arian.example.hazelcast.util.Constants.HZ_MAX_MEMORY_USE_PERCENTAGE;
import static com.arian.example.hazelcast.util.Constants.HZ_TIME_TO_LIVE_SECONDS;
